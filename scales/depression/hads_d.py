...
question_prompt = [
    ...
    "Continuing to enjoy activities as much as before (0: Definitely as much, 1: Not quite as much, 2: Only a little, 3: Hardly at all).",
    ...
    "Ability to laugh and see the humor in things (0: As much as always, 1: Not quite as much, 2: Definitely not as much, 3: Not at all).",

    # "I feel cheerful: 0 indicates Most of the time. 1 indicates Sometimes. 2 indicates Not often. 3 indicates Not at all."
    "Feeling cheerful (0: Most of the time, 1: Sometimes, 2: Not often, 3: Not at all).",
    ...
    "Feeling slowed down (0: Not at all, 1: Sometimes, 2: Very often, 3: Nearly all the time).",
    ...
    "Interest in personal appearance (0: Just as much care as ever, 1: Not quite as much care, 2: Not as much care as I should, 3: Definitely less care).",
    ...
    "Looking forward to things with enjoyment (0: As much as ever, 1: Rather less, 2: Definitely less, 3: Hardly at all).",
    ...
    "Enjoyment of a good book, radio, or TV program (0: Often, 1: Sometimes, 2: Not often, 3: Very seldom).",
]
