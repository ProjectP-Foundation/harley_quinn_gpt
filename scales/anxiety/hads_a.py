...
question_prompt = [
    ...
    "Feeling tense or 'wound up' (3: Most of the time, 2: A lot of the time, 1: Occasionally, 0: Not at all).",
    ...
    "Experiencing a frightened feeling as if something awful might happen (3: Very definitely, 2: Yes, but not too badly, 1: A little, but it doesn't worry me, 0: Not at all).",
    ...
    "Having worrying thoughts (3: A great deal of the time, 2: A lot of the time, 1: Occasionally, 0: Only occasionally).",
    ...
    "Feeling relaxed while sitting at ease (0: Definitely, 1: Usually, 2: Not Often, 3: Not at all).",
    ...
    "Experiencing a 'butterflies' sensation in the stomach (0: Not at all, 1: Occasionally, 2: Quite Often, 3: Very Often).",

    # "I feel restless as I have to be on the move: 3 Very much indeed 2 Quite a lot 1 Not very much 0 Not at all"
    "Feeling restless and needing to move (3: Very much indeed, 2: Quite a lot, 1: Not very much, 0: Not at all).",
    ...
    "Experiencing sudden feelings of panic (3: Very often, 2: Quite often, 1: Not very often, 0: Not at all).",
]
